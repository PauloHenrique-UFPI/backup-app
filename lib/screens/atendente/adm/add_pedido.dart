...
class PedidoPageState extends State<FazerPedidoAtendendePage> with ValidationsMixin {
  ...
  final TextEditingController valor = TextEditingController(text: '0.00');
  ...
  List<String> bebidasSelecionadas
      ...
      double dinheiro;
      try {
        dinheiro = double.parse(valor);
      } catch (e) {
        dinheiro = 0.0; 
      }
      String des = descricao ?? "";
      ...
      try {
        ...
        Response response = await dio.post(
          'https://api-veneza.onrender.com/criar-pedido', 
          data: body,
          options: Options(
            headers: {
